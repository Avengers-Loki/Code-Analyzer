...
function FileTreeItem({ node, repo, onFileClick, fetchChildren }: {
    ...
    return (
        <div className="select-none">
            <div
                className={`flex items-center gap-2 px-2 py-[3px] rounded-sm hover:bg-[var(--surface-hover)] cursor-pointer text-[13px] transition-colors ${isOpen ? 'text-[var(--primary)]' : 'text-[var(--text)]'}`}
