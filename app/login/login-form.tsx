    ...
    return (
        <div style={{
            ...
            <div style={{
                ...
                borderRadius: '8px',
                boxShadow: '0 4px 24px rgba(0,0,0,0.08)', // Soft shadow
                padding: '48px',
                display: 'flex',
                ...
                <div style={{ marginBottom: '24px', display: 'flex', alignItems: 'center', gap: '8px' }}>
                    ...
                    <span style={{ fontWeight: '700', fontSize: '1.25rem', color: '#1e293b' }}>CodeReviewX</span>
                </div>
                ...
                <form onSubmit={handleSubmit} style={{ width: '100%', display: 'flex', flexDirection: 'column', gap: '20px' }}>
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '6px' }}>
                        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                            ...
                            <Link href="/forgot" style={{ fontSize: '0.85rem', color: '#7c5dfa', textDecoration: 'none', fontWeight: '500' }}>
                                Forgot password?
                            </Link>
                        </div>
